...
public class DraftPick implements Serializable {
    ...
    Double PERSON_ID, ROUND_NUMBER, ROUND_PICK, OVERALL_PICK, TEAM_ID;
    String PLAYER_NAME, SEASON, DRAFT_TYPE, TEAM_CITY, TEAM_NAME, TEAM_ABBREVIATION, ORGANIZATION, ORGANIZATION_TYPE;


    public DraftPick(Double PERSON_ID, Double ROUND_NUMBER, Double ROUND_PICK, Double OVERALL_PICK, Double TEAM_ID, String PLAYER_NAME, String SEASON, String DRAFT_TYPE, String TEAM_CITY, String TEAM_NAME, String TEAM_ABBREVIATION, String ORGANIZATION, String ORGANIZATION_TYPE) {
    ...
    public Double getPERSON_ID() {
        return PERSON_ID;
    }

    public void setPERSON_ID(Double PERSON_ID) {
        this.PERSON_ID = PERSON_ID;
    }

    public Double getROUND_NUMBER() {
        return ROUND_NUMBER;
    }

    public void setROUND_NUMBER(Double ROUND_NUMBER) {
        this.ROUND_NUMBER = ROUND_NUMBER;
    }

    public Double getROUND_PICK() {
        return ROUND_PICK;
    }

    public void setROUND_PICK(Double ROUND_PICK) {
        this.ROUND_PICK = ROUND_PICK;
    }

    public Double getOVERALL_PICK() {
        return OVERALL_PICK;
    }

    public void setOVERALL_PICK(Double OVERALL_PICK) {
        this.OVERALL_PICK = OVERALL_PICK;
    }
